...
style = ('Arial', 40, 'bold')
write('Abdelrazek', font=style, align='center')
right(90)
forward(60)
color(colours['awesomeorange'])
write('Nageh', font=style, align='center')
hideturtle()
...
forward(40)
color(colours['reallyraspberry'])
write('Thanks', font=('Verdana', 25, 'bold'), align='center')
forward(40)
color(colours['deepsea'])
write('for yours', font=('Verdana', 18, 'bold'), align='center')
forward(40)
color(colours['awesomeorange'])
write('programing', font=('Verdana', 25, 'bold'), align='center')
forward(40)
color(colours['perfectpurple'])
write('you', font=style, align='center')
forward(40)

...
class Movie():
    ...
    def __init__(self, movie_title, movie_storyline,
        ...
        self.title = "training for python"
        self.storyline = "any thing"
        self.poster_image_url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSigzu4B5na1uVXokG5JGC72LfY2FMXH3UDiOz30K_EHVTofiVw"
        self.trailer_youtube_url = "https://www.youtube.com/watch?v=0mRWmsInZmE"
